...
var TwitterJsonLarge = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/blog/sample/json/json/testdata/twitter.json"
...
var TwitterJsonLargeEscaped = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/blog/sample/json/json/testdata/twitterescaped.json"
	bs, err := ioutil.ReadFile(file)
	if err != nil {
		panic(err)
	}
...
var TwitterJson = func() string {
	file := "/Users/bytedance/go/src/github.com/lxt1045/blog/sample/json/json/testdata/twitter_middle.json"
	bs, err := ioutil.ReadFile(file)
	if err != nil {
		panic(err)
	}
